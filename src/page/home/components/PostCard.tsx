...
const PostCard:React.FC<PostCardProps> = ({path, postid, userid, username, date, profile,describe})=>{
    ...
    return<React.Fragment>
      <div className="py-3 relative w-full  md:max-w-[30rem] 2xl:max-w-[35rem] 
        ...
        src={profile}/>
        <span>
        <p className={"tracking-wide font-medium text-neutral-900 dark:text-neutral-200text-[16px]"}>{username}</p>
          <div className={`flex text-[10px] items-center`}>
            {
            currentUser?.userid == userid ? 
              <p className="font-medium mr-1">author</p> : null
            }
        ...
        </span>
        {
            ...
            <p className="text-[14px] pt-3 dark:text-neutral-300
